...
new _vue2.default({
  ...
  ready: function ready() {
    //localStorage.clear();
    this.$http.get('api/api-key').then(function (value) {
...
},{"./components/Header.vue":2,"./components/Nav.vue":3,"./components/Progress.vue":4,"./filters":6,"./keyevents":7,"./player":8,"./store":10,"vue":19,"vue-resource":18}],2:[function(require,module,exports){
'use strict';
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<header :class=\"{'hideIndex': subNav}\">\n  <a class=\"title\" target=\"_blank\" href=\"{{ currentTrack.permalink_url }}\">\n    {{ currentTrack.title }}\n  </a>\n\n  <h3 class=\"author\">\n    {{ currentTrack.username }}\n  </h3>\n</header>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jose/Code/cloudradioo/client/app/components/Header.vue"
  if (!module.hot.data) {
...
},{"../player":8,"../store/actions":9,"vue":19,"vue-hot-reload-api":17}],3:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jose/Code/cloudradioo/client/app/components/Nav.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"../store/actions":9,"./Subnav.vue":5,"nouislider":15,"vue":19,"vue-hot-reload-api":17}],4:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jose/Code/cloudradioo/client/app/components/Progress.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"../store/actions":9,"vue":19,"vue-hot-reload-api":17}],5:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jose/Code/cloudradioo/client/app/components/Subnav.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"../store/actions":9,"vue":19,"vue-hot-reload-api":17}],6:[function(require,module,exports){
'use strict';
...
},{"./store":10,"./store/actions":9,"vue":19}],8:[function(require,module,exports){
'use strict';
...
var player = new _vue2.default({
  ...
  methods: {
    start: function start() {
      ...
      this.$http.get('api/all-genres').then(function (value) {
    ...
    initAllTracks: function initAllTracks() {
      ...
      this.$http.get('api/songs', { filters: this.userFilters }).then(function (value) {
    ...
    startPlaying: function startPlaying() {
      ...
      _store2.default.dispatch('CHANGE_TITLE', title);
...
},{"./store":10,"./store/actions":9,"vue":19,"vue-resource":18}],9:[function(require,module,exports){
'use strict';
...
},{"./modules/filter":11,"./modules/options":12,"./modules/player":13,"./modules/progress":14,"vue":19,"vuex":20}],11:[function(require,module,exports){
'use strict';
